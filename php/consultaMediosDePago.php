...
if ($numTicket == 0) {
	...
	FROM mediosdepago;";
// Si el ticket es distinto de cero quiere decir q es una venta ingresada,
// por lo tanto se obtiene el codigo de medio pago del ese ticket
}else{
	...
	UNION 
	SELECT mediosdepago.codMedioPAgo, mediosdepago.nombreMedioPago
	FROM mediosdepago;";
}
