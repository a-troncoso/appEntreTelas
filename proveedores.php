...
<body>
<div class="continer">
	<button type='button' id='btnNuevoProveedor' class='btnNuevoProveedor btn btn-primary' data-toggle='modal'><i class="fa fa-plus"></i> Nuevo</button>
	<div class="row" >
		<div class="col-md-12">
                    ...
                    <div class="col-md-12">
	                    <form class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-md-7">
									<input id="inpDireccionProveedorAEditar" class="form-control input-md" name="inpDireccionProveedorAEditar" type="text" >
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="col-md-4 control-label" for="selComunaProveedorAEditar">Comuna</label>
								<div class="col-md-7">
...
<!-- FIN VENTANA MODAL -->
	...
	$(document).ready(abrirModalEditarProveedor);
	</script>
</body>
</html>